...
> = {
  getSolar?: Resolver<
    ResolversTypes['Solar'],
    ParentType,
    ContextType,
    RequireFields<QueryGetSolarArgs, 'address'>
  >
...
export type SolarResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['Solar'] = ResolversParentTypes['Solar']
> = {
